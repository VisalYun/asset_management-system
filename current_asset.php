...
<body>
    ...
    <?php
        $total_current_assets_sql = "SELECT requests.*, assets.asset_name from requests INNER JOIN assets on requests.asset_id = assets.asset_id where owner_id = $user_id and status = 'Active' and is_deleted = 0;";
